...
//commande
router.post("/commandes/add", CommandeController.AddCommande);
router.put("/commandes/:id",  CommandeController.editCommande);
router.get("/commandes/:id", CommandeController.getCommandeById);
router.get("/commandes", CommandeController.getAllCommande);
router.delete("/commandes/:id", CommandeController.DeleteCommandeById);
router.post("/commandes/acceptcommande/:id", CommandeController.acceptcommande);
router.post("/commandes/denycommande/:id", CommandeController.denyCommande);
...
router.get("/itemlines/article/:article", ItemLineController.getItemLineByArticle);
